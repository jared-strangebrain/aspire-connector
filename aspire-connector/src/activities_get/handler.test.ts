...
import { activities_getHandler } from './handler';

/**
 * Test suite for activities_get
 * 
 * HTTP Method: GET
 * Endpoint: /Activities
 * 
 ...
 */
describe('activities_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(activities_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ActivitiesGetOutput
