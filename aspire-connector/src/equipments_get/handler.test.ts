...
import { equipments_getHandler } from './handler';

/**
 * Test suite for equipments_get
 * 
 * HTTP Method: GET
 * Endpoint: /Equipments
 * 
 ...
 */
describe('equipments_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipments_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentsGetOutput
