...
import { payment_categories_getHandler } from './handler';

/**
 * Test suite for payment_categories_get
 * 
 * HTTP Method: GET
 * Endpoint: /PaymentCategories
 * 
 ...
 */
describe('payment_categories_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(payment_categories_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PaymentCategoriesGetOutput
