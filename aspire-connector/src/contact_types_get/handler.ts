...
import { ContactTypesGetInput } from './input';
import { ContactTypesGetOutput } from './output';

export const contact_types_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  ContactTypesGetInput,
  ContactTypesGetOutput
>((handler) =>
