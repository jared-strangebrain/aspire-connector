...
import { contact_types_getHandler } from './handler';

/**
 * Test suite for contact_types_get
 * 
 * HTTP Method: GET
 ...
 */
describe('contact_types_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(contact_types_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ContactTypesGetOutput
