...
import { contact_custom_fields_getHandler } from './handler';

/**
 * Test suite for contact_custom_fields_get
 * 
 * HTTP Method: GET
 ...
 */
describe('contact_custom_fields_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(contact_custom_fields_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ContactCustomFieldsGetOutput
