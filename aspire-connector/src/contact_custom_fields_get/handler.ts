...
import { ContactCustomFieldsGetInput } from './input';
import { ContactCustomFieldsGetOutput } from './output';

export const contact_custom_fields_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  ContactCustomFieldsGetInput,
  ContactCustomFieldsGetOutput
>((handler) =>
  handler.usingHttp((http) =>
    http.get('/ContactCustomFields')
