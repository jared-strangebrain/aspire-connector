...
import { divisions_getHandler } from './handler';

/**
 * Test suite for divisions_get
 * 
 * HTTP Method: GET
 * Endpoint: /Divisions
 * 
 ...
 */
describe('divisions_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(divisions_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as DivisionsGetOutput
