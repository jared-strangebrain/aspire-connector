...
import { invoice_batches_getHandler } from './handler';

/**
 * Test suite for invoice_batches_get
 * 
 * HTTP Method: GET
 * Endpoint: /InvoiceBatches
 * 
 ...
 */
describe('invoice_batches_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(invoice_batches_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as InvoiceBatchesGetOutput
