...
import { clock_times_getHandler } from './handler';

/**
 * Test suite for clock_times_get
 * 
 * HTTP Method: GET
 * Endpoint: /ClockTimes
 * 
 ...
 */
describe('clock_times_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(clock_times_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ClockTimesGetOutput
