...
/**
 * Test suite for work_tickets_create_as_needed_work_tickets
 * 
 * HTTP Method: POST
 * Endpoint: /WorkTickets/CreateAsNeededWorkTickets
 * 
 * REQUIRED INPUTS:
 *   - body (request body)
 * 
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as WorkTicketsCreateAsNeededWorkTicketsOutput
