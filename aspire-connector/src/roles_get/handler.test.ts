...
import { roles_getHandler } from './handler';

/**
 * Test suite for roles_get
 * 
 * HTTP Method: GET
 * Endpoint: /Roles
 * 
 ...
 */
describe('roles_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(roles_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as RolesGetOutput
