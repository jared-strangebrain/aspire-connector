...
import { certifications_getHandler } from './handler';

/**
 * Test suite for certifications_get
 * 
 * HTTP Method: GET
 ...
 */
describe('certifications_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(certifications_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as CertificationsGetOutput
