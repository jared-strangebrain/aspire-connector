...
import { CertificationsGetInput } from './input';
import { CertificationsGetOutput } from './output';

export const certifications_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  CertificationsGetInput,
  CertificationsGetOutput
>((handler) =>
