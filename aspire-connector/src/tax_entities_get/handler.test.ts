...
import { tax_entities_getHandler } from './handler';

/**
 * Test suite for tax_entities_get
 * 
 * HTTP Method: GET
 ...
 */
describe('tax_entities_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(tax_entities_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as TaxEntitiesGetOutput
