...
import { activity_categories_getHandler } from './handler';

/**
 * Test suite for activity_categories_get
 * 
 * HTTP Method: GET
 ...
 */
describe('activity_categories_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(activity_categories_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ActivityCategoriesGetOutput
