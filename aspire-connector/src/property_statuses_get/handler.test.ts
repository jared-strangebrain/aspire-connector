...
import { property_statuses_getHandler } from './handler';

/**
 * Test suite for property_statuses_get
 * 
 * HTTP Method: GET
 * Endpoint: /PropertyStatuses
 * 
 ...
 */
describe('property_statuses_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_statuses_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyStatusesGetOutput
