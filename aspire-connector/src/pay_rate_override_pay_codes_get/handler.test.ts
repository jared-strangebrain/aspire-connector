...
import { pay_rate_override_pay_codes_getHandler } from './handler';

/**
 * Test suite for pay_rate_override_pay_codes_get
 * 
 * HTTP Method: GET
 ...
 */
describe('pay_rate_override_pay_codes_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(pay_rate_override_pay_codes_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PayRateOverridePayCodesGetOutput
