...
import { equipment_requested_services_getHandler } from './handler';

/**
 * Test suite for equipment_requested_services_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentRequestedServices
 * 
 ...
 */
describe('equipment_requested_services_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_requested_services_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentRequestedServicesGetOutput
