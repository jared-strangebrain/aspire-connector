...
import { property_groups_getHandler } from './handler';

/**
 * Test suite for property_groups_get
 * 
 * HTTP Method: GET
 * Endpoint: /PropertyGroups
 * 
 ...
 */
describe('property_groups_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_groups_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyGroupsGetOutput
