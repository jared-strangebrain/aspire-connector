...
import { invoice_taxes_getHandler } from './handler';

/**
 * Test suite for invoice_taxes_get
 * 
 * HTTP Method: GET
 * Endpoint: /InvoiceTaxes
 * 
 ...
 */
describe('invoice_taxes_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(invoice_taxes_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as InvoiceTaxesGetOutput
