...
import { takeoff_groups_getHandler } from './handler';

/**
 * Test suite for takeoff_groups_get
 * 
 * HTTP Method: GET
 * Endpoint: /TakeoffGroups
 * 
 ...
 */
describe('takeoff_groups_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(takeoff_groups_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as TakeoffGroupsGetOutput
