...
import { opportunity_lost_reasons_getHandler } from './handler';

/**
 * Test suite for opportunity_lost_reasons_get
 * 
 * HTTP Method: GET
 ...
 */
describe('opportunity_lost_reasons_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(opportunity_lost_reasons_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunityLostReasonsGetOutput
