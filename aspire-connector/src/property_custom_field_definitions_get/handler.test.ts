...
import { property_custom_field_definitions_getHandler } from './handler';

/**
 * Test suite for property_custom_field_definitions_get
 * 
 * HTTP Method: GET
 * Endpoint: /PropertyCustomFieldDefinitions
 * 
 ...
 */
describe('property_custom_field_definitions_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_custom_field_definitions_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyCustomFieldDefinitionsGetOutput
