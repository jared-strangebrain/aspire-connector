...
import { equipment_service_logs_getHandler } from './handler';

/**
 * Test suite for equipment_service_logs_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentServiceLogs
 * 
 ...
 */
describe('equipment_service_logs_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_service_logs_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentServiceLogsGetOutput
