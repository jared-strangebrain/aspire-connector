...
import { services_getHandler } from './handler';

/**
 * Test suite for services_get
 * 
 * HTTP Method: GET
 * Endpoint: /Services
 * 
...
describe('services_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(services_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ServicesGetOutput
