...
import { WorkTicketItemsGetInput } from './input';
import { WorkTicketItemsGetOutput } from './output';

export const work_ticket_items_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  WorkTicketItemsGetInput,
  WorkTicketItemsGetOutput
>((handler) =>
  handler.withGlobalConfiguration(globalConfigHttp).usingHttp((http) =>
    http.get('/WorkTicketItems')
