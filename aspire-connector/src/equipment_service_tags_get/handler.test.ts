...
import { equipment_service_tags_getHandler } from './handler';

/**
 * Test suite for equipment_service_tags_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentServiceTags
 * 
 ...
 */
describe('equipment_service_tags_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_service_tags_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentServiceTagsGetOutput
