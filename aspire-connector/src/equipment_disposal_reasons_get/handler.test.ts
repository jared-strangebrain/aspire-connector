...
import { equipment_disposal_reasons_getHandler } from './handler';

/**
 * Test suite for equipment_disposal_reasons_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentDisposalReasons
 * 
 ...
 */
describe('equipment_disposal_reasons_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_disposal_reasons_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentDisposalReasonsGetOutput
