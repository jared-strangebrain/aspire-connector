...
import { property_availabilities_createHandler } from './handler';

/**
 * Test suite for property_availabilities_create
 * 
 * HTTP Method: POST
 * Endpoint: /PropertyAvailabilities
 * 
 * REQUIRED INPUTS:
 *   - body (Request body)
 * 
 ...
 */
describe.skip('property_availabilities_create', () => {  // Skipped for deployment - enable after adding real test data
  OperationHandlerTestSetup.configureHandlerTest(property_availabilities_createHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyAvailabilitiesCreateOutput
