...
import { service_type_integration_codes_getHandler } from './handler';

/**
 * Test suite for service_type_integration_codes_get
 * 
 * HTTP Method: GET
 * Endpoint: /ServiceTypeIntegrationCodes
 * 
 ...
 */
describe('service_type_integration_codes_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(service_type_integration_codes_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ServiceTypeIntegrationCodesGetOutput
