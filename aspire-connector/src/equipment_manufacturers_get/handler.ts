...
import { EquipmentManufacturersGetInput } from './input';
import { EquipmentManufacturersGetOutput } from './output';

export const equipment_manufacturers_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  EquipmentManufacturersGetInput,
  EquipmentManufacturersGetOutput
>((handler) =>
  handler.usingHttp((http) =>
    http.get('/EquipmentManufacturers')
