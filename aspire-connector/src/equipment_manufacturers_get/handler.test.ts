...
import { equipment_manufacturers_getHandler } from './handler';

/**
 * Test suite for equipment_manufacturers_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentManufacturers
 * 
 ...
 */
describe('equipment_manufacturers_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_manufacturers_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentManufacturersGetOutput
