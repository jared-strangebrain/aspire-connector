...
import { property_types_getHandler } from './handler';

/**
 * Test suite for property_types_get
 * 
 * HTTP Method: GET
 ...
 */
describe('property_types_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_types_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyTypesGetOutput
