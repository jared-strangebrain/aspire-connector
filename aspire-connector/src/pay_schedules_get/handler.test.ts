...
import { pay_schedules_getHandler } from './handler';

/**
 * Test suite for pay_schedules_get
 * 
 * HTTP Method: GET
 ...
 */
describe('pay_schedules_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(pay_schedules_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PaySchedulesGetOutput
