...
import { employee_incidents_getHandler } from './handler';

/**
 * Test suite for employee_incidents_get
 * 
 * HTTP Method: GET
 * Endpoint: /EmployeeIncidents
 * 
 ...
 */
describe('employee_incidents_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(employee_incidents_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EmployeeIncidentsGetOutput
