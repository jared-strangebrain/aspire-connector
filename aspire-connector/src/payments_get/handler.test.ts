...
import { payments_getHandler } from './handler';

/**
 * Test suite for payments_get
 * 
 * HTTP Method: GET
 * Endpoint: /Payments
 * 
 ...
 */
describe('payments_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(payments_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PaymentsGetOutput
