...
import { opportunity_services_getHandler } from './handler';

/**
 * Test suite for opportunity_services_get
 * 
 * HTTP Method: GET
 * Endpoint: /OpportunityServices
 * 
 ...
 */
describe('opportunity_services_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(opportunity_services_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunityServicesGetOutput
