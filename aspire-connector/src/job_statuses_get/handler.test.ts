...
import { job_statuses_getHandler } from './handler';

/**
 * Test suite for job_statuses_get
 * 
 * HTTP Method: GET
 * Endpoint: /JobStatuses
 * 
 ...
 */
describe('job_statuses_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(job_statuses_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as JobStatusesGetOutput
