...
import { invoices_getHandler } from './handler';

/**
 * Test suite for invoices_get
 * 
 * HTTP Method: GET
 * Endpoint: /Invoices
 * 
...
describe('invoices_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(invoices_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as InvoicesGetOutput
