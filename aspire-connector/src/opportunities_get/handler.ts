...
import { OpportunitiesGetInput } from './input';
import { OpportunitiesGetOutput } from './output';

export const opportunities_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  OpportunitiesGetInput,
  OpportunitiesGetOutput
>((handler) =>
