...
import { opportunities_getHandler } from './handler';

/**
 * Test suite for opportunities_get
 * 
 * HTTP Method: GET
 ...
 */
describe('opportunities_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(opportunities_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunitiesGetOutput
