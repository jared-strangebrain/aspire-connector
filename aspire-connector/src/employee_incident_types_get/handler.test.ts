...
import { employee_incident_types_getHandler } from './handler';

/**
 * Test suite for employee_incident_types_get
 * 
 * HTTP Method: GET
 * Endpoint: /EmployeeIncidentTypes
 * 
 ...
 */
describe('employee_incident_types_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(employee_incident_types_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EmployeeIncidentTypesGetOutput
