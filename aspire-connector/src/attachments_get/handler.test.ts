...
import { attachments_getHandler } from './handler';

/**
 * Test suite for attachments_get
 * 
 * HTTP Method: GET
 ...
 */
describe('attachments_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(attachments_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as AttachmentsGetOutput
