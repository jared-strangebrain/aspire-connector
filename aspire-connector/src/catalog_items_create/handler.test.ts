...
import { catalog_items_createHandler } from './handler';

/**
 * Test suite for catalog_items_create
 * 
 * HTTP Method: POST
 ...
 */
describe.skip('catalog_items_create', () => {  // Skipped for deployment - enable after adding real test data
  OperationHandlerTestSetup.configureHandlerTest(catalog_items_createHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as CatalogItemsCreateOutput
