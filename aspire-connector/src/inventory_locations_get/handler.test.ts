...
import { inventory_locations_getHandler } from './handler';

/**
 * Test suite for inventory_locations_get
 * 
 * HTTP Method: GET
 ...
 */
describe('inventory_locations_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(inventory_locations_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as InventoryLocationsGetOutput
