...
import { localities_getHandler } from './handler';

/**
 * Test suite for localities_get
 * 
 * HTTP Method: GET
 * Endpoint: /Localities
 * 
 ...
 */
describe('localities_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(localities_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as LocalitiesGetOutput
