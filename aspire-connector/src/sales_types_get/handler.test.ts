...
import { sales_types_getHandler } from './handler';

/**
 * Test suite for sales_types_get
 * 
 * HTTP Method: GET
 * Endpoint: /SalesTypes
 * 
 ...
 */
describe('sales_types_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(sales_types_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as SalesTypesGetOutput
