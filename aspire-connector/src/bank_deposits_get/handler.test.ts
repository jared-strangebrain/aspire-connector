...
import { bank_deposits_getHandler } from './handler';

/**
 * Test suite for bank_deposits_get
 * 
 * HTTP Method: GET
 ...
 */
describe('bank_deposits_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(bank_deposits_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as BankDepositsGetOutput
