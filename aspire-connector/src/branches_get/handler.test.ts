...
import { branches_getHandler } from './handler';

/**
 * Test suite for branches_get
 * 
 * HTTP Method: GET
 * Endpoint: /Branches
 * 
 ...
 */
describe('branches_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(branches_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as BranchesGetOutput
