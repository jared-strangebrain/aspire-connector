...
import { service_types_getHandler } from './handler';

/**
 * Test suite for service_types_get
 * 
 * HTTP Method: GET
 ...
 */
describe('service_types_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(service_types_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ServiceTypesGetOutput
