...
import { catalog_item_categories_getHandler } from './handler';

/**
 * Test suite for catalog_item_categories_get
 * 
 * HTTP Method: GET
 * Endpoint: /CatalogItemCategories
 * 
 ...
 */
describe('catalog_item_categories_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(catalog_item_categories_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as CatalogItemCategoriesGetOutput
