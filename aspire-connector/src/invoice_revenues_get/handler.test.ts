...
import { invoice_revenues_getHandler } from './handler';

/**
 * Test suite for invoice_revenues_get
 * 
 * HTTP Method: GET
 * Endpoint: /InvoiceRevenues
 * 
 ...
 */
describe('invoice_revenues_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(invoice_revenues_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as InvoiceRevenuesGetOutput
