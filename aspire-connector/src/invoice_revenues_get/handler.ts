...
import { InvoiceRevenuesGetInput } from './input';
import { InvoiceRevenuesGetOutput } from './output';

export const invoice_revenues_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  InvoiceRevenuesGetInput,
  InvoiceRevenuesGetOutput
>((handler) =>
  handler.usingHttp((http) =>
    http.get('/InvoiceRevenues')
