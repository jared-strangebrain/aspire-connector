...
import { ContactCustomFieldDefinitionsGetInput } from './input';
import { ContactCustomFieldDefinitionsGetOutput } from './output';

export const contact_custom_field_definitions_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  ContactCustomFieldDefinitionsGetInput,
  ContactCustomFieldDefinitionsGetOutput
>((handler) =>
  handler.usingHttp((http) =>
    http.get('/ContactCustomFieldDefinitions')
