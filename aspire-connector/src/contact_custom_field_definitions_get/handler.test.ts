...
import { contact_custom_field_definitions_getHandler } from './handler';

/**
 * Test suite for contact_custom_field_definitions_get
 * 
 * HTTP Method: GET
 * Endpoint: /ContactCustomFieldDefinitions
 * 
 ...
 */
describe('contact_custom_field_definitions_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(contact_custom_field_definitions_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ContactCustomFieldDefinitionsGetOutput
