...
import { work_ticket_canceled_reasons_getHandler } from './handler';

/**
 * Test suite for work_ticket_canceled_reasons_get
 * 
 * HTTP Method: GET
 * Endpoint: /WorkTicketCanceledReasons
 * 
 ...
 */
describe('work_ticket_canceled_reasons_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(work_ticket_canceled_reasons_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as WorkTicketCanceledReasonsGetOutput
