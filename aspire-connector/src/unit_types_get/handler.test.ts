...
import { unit_types_getHandler } from './handler';

/**
 * Test suite for unit_types_get
 * 
 * HTTP Method: GET
 * Endpoint: /UnitTypes
 * 
 ...
 */
describe('unit_types_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(unit_types_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as UnitTypesGetOutput
