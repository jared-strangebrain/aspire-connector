...
import { addresses_getHandler } from './handler';

/**
 * Test suite for addresses_get
 * 
 * HTTP Method: GET
 * Endpoint: /Addresses
 * 
 ...
 */
describe('addresses_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(addresses_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as AddressesGetOutput
