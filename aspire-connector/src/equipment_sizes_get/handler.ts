...
import { EquipmentSizesGetInput } from './input';
import { EquipmentSizesGetOutput } from './output';

export const equipment_sizes_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  EquipmentSizesGetInput,
  EquipmentSizesGetOutput
>((handler) =>
  handler.withGlobalConfiguration(globalConfigHttp).usingHttp((http) =>
    http.get('/EquipmentSizes')
