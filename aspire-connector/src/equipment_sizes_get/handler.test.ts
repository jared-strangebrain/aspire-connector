...
import { equipment_sizes_getHandler } from './handler';

/**
 * Test suite for equipment_sizes_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentSizes
 * 
 ...
 */
describe('equipment_sizes_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_sizes_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentSizesGetOutput
