...
import { property_contacts_getHandler } from './handler';

/**
 * Test suite for property_contacts_get
 * 
 * HTTP Method: GET
 ...
 */
describe('property_contacts_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_contacts_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyContactsGetOutput
