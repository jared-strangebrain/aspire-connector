...
import { item_allocations_getHandler } from './handler';

/**
 * Test suite for item_allocations_get
 * 
 * HTTP Method: GET
 ...
 */
describe('item_allocations_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(item_allocations_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ItemAllocationsGetOutput
