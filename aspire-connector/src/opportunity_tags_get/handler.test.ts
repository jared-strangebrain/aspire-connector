...
import { opportunity_tags_getHandler } from './handler';

/**
 * Test suite for opportunity_tags_get
 * 
 * HTTP Method: GET
 ...
 */
describe('opportunity_tags_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(opportunity_tags_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunityTagsGetOutput
