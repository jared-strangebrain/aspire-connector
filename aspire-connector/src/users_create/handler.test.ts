...
import { users_createHandler } from './handler';

/**
 * Test suite for users_create
 * 
 * HTTP Method: POST
 * Endpoint: /Users
 * 
 ...
 */
describe.skip('users_create', () => {  // Skipped for deployment - enable after adding real test data
  OperationHandlerTestSetup.configureHandlerTest(users_createHandler, (handlerTest) =>
    handlerTest
        ...
        testCase
          ...
          .when((ctx, testContext) => (// NOTE: May need to update IDs and values for your specific API instance
          {
            body: {
              ...
              ExternalContactReference: 'test-value',
              Password: 'test-value',
              Active: true,
              UserRoles: [1]
            }
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as UsersCreateOutput
