...
import { property_custom_fields_getHandler } from './handler';

/**
 * Test suite for property_custom_fields_get
 * 
 * HTTP Method: GET
 ...
 */
describe('property_custom_fields_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_custom_fields_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyCustomFieldsGetOutput
