...
import { property_availabilities_getHandler } from './handler';

/**
 * Test suite for property_availabilities_get
 * 
 * HTTP Method: GET
 ...
 */
describe('property_availabilities_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(property_availabilities_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as PropertyAvailabilitiesGetOutput
