...
import { receipt_statuses_getHandler } from './handler';

/**
 * Test suite for receipt_statuses_get
 * 
 * HTTP Method: GET
 * Endpoint: /ReceiptStatuses
 * 
 ...
 */
describe('receipt_statuses_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(receipt_statuses_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ReceiptStatusesGetOutput
