...
import { equipment_classes_getHandler } from './handler';

/**
 * Test suite for equipment_classes_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentClasses
 * 
 ...
 */
describe('equipment_classes_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_classes_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentClassesGetOutput
