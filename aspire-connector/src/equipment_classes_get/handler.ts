...
import { EquipmentClassesGetInput } from './input';
import { EquipmentClassesGetOutput } from './output';

export const equipment_classes_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  EquipmentClassesGetInput,
  EquipmentClassesGetOutput
>((handler) =>
  handler.withGlobalConfiguration(globalConfigHttp).usingHttp((http) =>
    http.get('/EquipmentClasses')
