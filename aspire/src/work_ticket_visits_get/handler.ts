...
import { WorkTicketVisitsGetInput } from "./input";
import { WorkTicketVisitsGetOutput } from "./output";
import { globalConfigHttp } from "../GlobalConfig";

        export const workTicketVisitsGetHandler = OperationHandlerSetup.configureHandler<
          AspireAuth,
          WorkTicketVisitsGetInput,
          WorkTicketVisitsGetOutput
        >((handler) =>
          handler.withGlobalConfiguration(globalConfigHttp).usingHttp((http) =>
            http
              .get("https://cloud-api.youraspire.com/WorkTicketVisits")
