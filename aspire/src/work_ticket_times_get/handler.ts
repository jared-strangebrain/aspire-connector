...
import { WorkTicketTimesGetInput } from "./input";
import { WorkTicketTimesGetOutput } from "./output";
import { globalConfigHttp } from "../GlobalConfig";

        export const workTicketTimesGetHandler = OperationHandlerSetup.configureHandler<
          AspireAuth,
          WorkTicketTimesGetInput,
          WorkTicketTimesGetOutput
        >((handler) =>
          handler.withGlobalConfiguration(globalConfigHttp).usingHttp((http) =>
            http
              .get("https://cloud-api.youraspire.com/WorkTicketTimes")
