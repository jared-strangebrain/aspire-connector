...
import { OpportunityServicesGetInput } from './input';
import { OpportunityServicesGetOutput } from './output';

export const opportunity_services_getHandler = OperationHandlerSetup.configureHandler<
  AspireConnectorAuth,
  OpportunityServicesGetInput,
  OpportunityServicesGetOutput
>((handler) =>
  handler.withGlobalConfiguration(globalConfigHttp).usingHttp((http) =>
    http.get('/OpportunityServices')
