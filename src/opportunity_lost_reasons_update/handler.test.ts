...
import { opportunity_lost_reasons_updateHandler } from './handler';

/**
 * Test suite for opportunity_lost_reasons_update
 * 
 * HTTP Method: PUT
 ...
 */
describe.skip('opportunity_lost_reasons_update', () => {  // Skipped for deployment - enable after adding real test data
  OperationHandlerTestSetup.configureHandlerTest(opportunity_lost_reasons_updateHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunityLostReasonsUpdateOutput
