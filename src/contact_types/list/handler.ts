...
export const listContactTypesHandler = OperationHandlerSetup
  configure("contact_types.list", (handler: any) =>
    handler.usingComposite(async (ctx: any, input: ListContactTypesInput) => {
