...
/**
 * Test suite for tax_jurisdictions_get
 * 
 * HTTP Method: GET
 ...
 */
describe('tax_jurisdictions_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(tax_jurisdictions_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as TaxJurisdictionsGetOutput
