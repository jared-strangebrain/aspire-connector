...
import { opportunity_statuses_getHandler } from './handler';

/**
 * Test suite for opportunity_statuses_get
 * 
 * HTTP Method: GET
 * Endpoint: /OpportunityStatuses
 * 
 ...
 */
describe('opportunity_statuses_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(opportunity_statuses_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunityStatusesGetOutput
