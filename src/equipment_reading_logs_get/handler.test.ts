...
import { equipment_reading_logs_getHandler } from './handler';

/**
 * Test suite for equipment_reading_logs_get
 * 
 * HTTP Method: GET
 ...
 */
describe('equipment_reading_logs_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_reading_logs_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentReadingLogsGetOutput
