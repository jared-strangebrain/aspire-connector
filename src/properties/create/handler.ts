...
export const createPropertiesHandler = OperationHandlerSetup
  configure("properties.create", (handler: any) =>
    handler.usingComposite(async (ctx: any, input: CreatePropertiesInput) => {
      ...
      return OperationHandlerResult.success(text as any as CreatePropertiesOutput);
    })
  );
