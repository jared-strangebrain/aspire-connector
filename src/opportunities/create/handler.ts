...
export const createOpportunitiesHandler = OperationHandlerSetup
  configure("opportunities.create", (handler: any) =>
    handler.usingComposite(async (ctx: any, input: CreateOpportunitiesInput) => {
      ...
      return OperationHandlerResult.success(text as any as CreateOpportunitiesOutput);
    })
  );
