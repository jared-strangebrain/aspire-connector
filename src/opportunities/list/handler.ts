...
export const listOpportunitiesHandler = OperationHandlerSetup
  configure("opportunities.list", (handler: any) =>
    handler.usingComposite(async (ctx: any, input: ListOpportunitiesInput) => {
