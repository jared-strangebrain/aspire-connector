...
import { users_getHandler } from './handler';

/**
 * Test suite for users_get
 * 
 * HTTP Method: GET
 * Endpoint: /Users
 * 
 ...
 */
describe('users_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(users_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as UsersGetOutput
