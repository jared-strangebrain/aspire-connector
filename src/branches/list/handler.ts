...
export const listBranchesHandler = OperationHandlerSetup
  configure("branches.list", (handler: any) =>
    handler.usingComposite(async (ctx: any, input: ListBranchesInput) => {
      ...
      return OperationHandlerResult.success(data as ListBranchesOutput);
    })
  );
