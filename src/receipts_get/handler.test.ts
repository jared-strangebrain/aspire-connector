...
import { receipts_getHandler } from './handler';

/**
 * Test suite for receipts_get
 * 
 * HTTP Method: GET
 * Endpoint: /Receipts
 * 
 ...
 */
describe('receipts_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(receipts_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ReceiptsGetOutput
