...
import { companies_getHandler } from './handler';

/**
 * Test suite for companies_get
 * 
 * HTTP Method: GET
 * Endpoint: /Companies
 * 
 ...
 */
describe('companies_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(companies_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as CompaniesGetOutput
