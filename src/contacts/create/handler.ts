...
export const createContactsHandler = OperationHandlerSetup
  configure("contacts.create", (handler: any) =>
    handler.usingComposite(async (ctx: any, input: CreateContactsInput) => {
      ...
      return OperationHandlerResult.success(text as any as CreateContactsOutput);
    })
  );
