...
import { opportunity_service_groups_getHandler } from './handler';

/**
 * Test suite for opportunity_service_groups_get
 * 
 * HTTP Method: GET
 * Endpoint: /OpportunityServiceGroups
 * 
 ...
 */
describe('opportunity_service_groups_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(opportunity_service_groups_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as OpportunityServiceGroupsGetOutput
