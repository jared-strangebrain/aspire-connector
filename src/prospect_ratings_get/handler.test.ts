...
import { prospect_ratings_getHandler } from './handler';

/**
 * Test suite for prospect_ratings_get
 * 
 * HTTP Method: GET
 * Endpoint: /ProspectRatings
 * 
 ...
 */
describe('prospect_ratings_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(prospect_ratings_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as ProspectRatingsGetOutput
