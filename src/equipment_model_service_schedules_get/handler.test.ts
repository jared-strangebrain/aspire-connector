...
import { equipment_model_service_schedules_getHandler } from './handler';

/**
 * Test suite for equipment_model_service_schedules_get
 * 
 * HTTP Method: GET
 * Endpoint: /EquipmentModelServiceSchedules
 * 
 ...
 */
describe('equipment_model_service_schedules_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(equipment_model_service_schedules_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as EquipmentModelServiceSchedulesGetOutput
