...
import { vendors_getHandler } from './handler';

/**
 * Test suite for vendors_get
 * 
 * HTTP Method: GET
 * Endpoint: /Vendors
 * 
 ...
 */
describe('vendors_get', () => {
  OperationHandlerTestSetup.configureHandlerTest(vendors_getHandler, (handlerTest) =>
    handlerTest
      ...
      .testCase('should succeed with minimal required inputs', (testCase) =>
        testCase
          ...
          .then(({ output }) => {
            ...
            if (output.isSuccess) {
              // Output is properly typed as VendorsGetOutput
